...
def main(argv):
    ...
    if arg_network_id == '' or arg_device_id == '':
        printhelp(argv)
        sys.exit(2)
    ...
    try:
        result = client.sm.getNetworkSmDeviceProfiles(networkId=arg_network_id, deviceId=arg_device_id)
        print(result)
...
def printhelp(passedargvs):
    ...
    print(' -d <device ID>       : Your Meraki Dashboard device ID')
    print('')
    print('You passed:')
    print(passedargvs)
